...
#         # Manual focus control (text box only)
#         self.edit_focus = QLineEdit("2085")
...
#         self.edit_light = QLineEdit("0")
#         self.edit_light.setFixedWidth(60)
#         self.edit_light.returnPressed.connect(self.onLightEdit)
#         self.lbl_light = QLabel("Light: 0")
#         hlyt_light = QHBoxLayout()
#         hlyt_light.addWidget(self.lbl_light)
#         hlyt_light.addWidget(self.slider_light)
#         hlyt_light.addWidget(self.edit_light)
#         vlytctrl.addLayout(hlyt_light)
...
#         self.edit_name.setInsertPolicy(QComboBox.InsertAtTop)
...
#         hlyt_af = QHBoxLayout()
#         hlyt_af.addWidget(self.btn_af_auto)
#         hlyt_af.addWidget(self.btn_af_off)
#         vlytctrl.addLayout(hlyt_af)
...
#             image.save(fname)
#             self.edit_name.insertItem(0, name)
...
#                     cam_id = self.combo_camera.itemData(idx)
#                 self.closeCamera()
#                 QMessageBox.warning(self, "Warning", "Camera disconnect. Attempting to reconnect...")
#                 # Try to reconnect after 2 seconds
#                 QTimer.singleShot(2000, lambda: self.tryReconnect(cam_id))

#     def tryReconnect(self, cam_id):
#         if cam_id is not None:
#             self.openCamera(cam_id)
#             if self.hcam:
#                 QMessageBox.information(self, "Reconnected", "Camera reconnected successfully.")
#             else:
#                 QMessageBox.warning(self, "Reconnect Failed", "Failed to reconnect camera. Please check hardware.")
...
#         self.lbl_zoom.setText(f"Zoom: {value}")
#         self.edit_zoom.setText(str(value))
#         if self.hcam is not None:
#             try:
#                 self.hcam.put(uvcham.UVCHAM_ZOOM, value)
...
#             fval = float(val)
#             if self.hcam is not None:
#                 self.hcam.put(uvcham.UVCHAM_ZOOM, int(fval * 10))  # Assuming zoom is set as integer tenths
#         except Exception:
#             pass
...
#     def onLightEdit(self):
#         val = self.edit_light.text()
#         try:
#             ival = int(val)
#             if 0 <= ival <= 22:
#                 self.slider_light.setValue(ival)
#         except Exception:
#             pass
...
#                 self.btn_af_auto.setEnabled(True)
#                 self.btn_af_off.setEnabled(True)
#                 self.edit_zoom.setEnabled(True)
#                 self.edit_focus.setEnabled(True)

#                 # Set default values
#                 try:
#                     self.hcam.put(uvcham.UVCHAM_AFPOSITION, 2085)
#                     self.edit_focus.setText("2085")
#                 except Exception:
#                     pass
#                 try:
#                     self.hcam.put(uvcham.UVCHAM_ZOOM, 15)  # 1.5x zoom
#                     self.edit_zoom.setText("1.5")
#                 except Exception:
#                     pass
...
#         self.btn_af_auto.setEnabled(False)
#         self.btn_af_off.setEnabled(False)
#         self.edit_zoom.setEnabled(False)
#         self.edit_focus.setEnabled(False)
#         self.slider_light.setEnabled(False)
#         self.edit_light.setEnabled(False)
